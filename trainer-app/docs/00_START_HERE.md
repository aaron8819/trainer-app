...
- `docs/10_HYPERTROPHY_NORTH_STAR.md`: north-star strategy and migration map for the first-principles hypertrophy mesocycle planner; not current runtime behavior until implemented

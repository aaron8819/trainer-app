...
- The log page keeps the logging workflow focused on execution controls and no longer renders the receipt-first session summary card; workout detail remains the user-facing session summary surface (`src/app/log/[id]/page.tsx`, `src/app/workout/[id]/page.tsx`, `src/components/explainability/SessionContextCard.tsx`).

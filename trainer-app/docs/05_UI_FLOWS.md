...
- The active log UI also shows a session elapsed timer. It is per-workout session-storage state, remains UI/session-local, and is not written to set logs, workout save payloads, receipts, seed replay, or planner/runtime policy.

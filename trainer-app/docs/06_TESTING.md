...
- Add-exercise mutation coverage: `src/app/api/workouts/[id]/add-exercise/route.test.ts` asserts reconciliation persistence, revision increment, and returned log-row capabilities on structural mutation.

...
The V4 reference proofs deliberately keep four owners distinct: the released
25-placement submitted fixture and expected matrix retain their original names,
while the revised 26-placement submitted fixture and expected modules use
`revised` names. Submitted fixtures never import expected modules, expected
modules never import submitted fixtures, and the PostgreSQL harness binds each
side to disposable database IDs independently. Expected prescriptions are

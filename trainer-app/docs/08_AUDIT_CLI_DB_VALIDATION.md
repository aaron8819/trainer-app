...
- The main `mesocycle-explain` artifact is the operator artifact: it keeps read-only markers, no-repair summary, replacement readiness, compact V2 summary, top operator findings, and a debug-artifact manifest. It does not carry the full V2 diagnostic payload.

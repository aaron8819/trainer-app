...
Current V2 lane-intent benchmark note, 2026-06-13: the plan-quality benchmark now includes `lane_intent_explicitness`, sourced from `V2LaneSelectionIntentAudit` and the pure `buildV2LaneSelectionIntentBenchmark()` expectation model. Read it as candidate-quality evidence for high-risk jobs: calf direct, hamstring curl, side/rear delt direct, chest-biased press support, vertical-pull anchor, and optional low-axial hip extension. A warning here is a bounded lane-intent contract watch, not an instruction to change materializer ranking. Required lane jobs currently pass; low-axial hip extension is a diagnostic watch. Taxonomy now recognizes Reverse Hyperextension as `low_axial_hip_extension_anchor`; the remaining missing contract should explain that the future lane job is low-axial posterior-chain support, not `hinge_compound` overload, not knee-flexion curl, not generic glute accessory work, and not back-extension or other lower-back-heavy hinge closure. The expected contract is support coverage with low axial fatigue, loadable direct-or-high-support hip-extension stimulus, meaningful Glutes contribution, clean-variation preference, allowed hip-thrust/bridge/pull-through/reverse-hyper family, and explicit disallowance of true hinge, hamstring curl, and back-extension substitution. The gate remains read-only and must not feed demand, materializer behavior, seed/runtime/receipts, acceptance thresholds, repair behavior, DB writes, or persistence.

              ...
              rows: [
                {
                  ...
                  sourceEvidence: ["Side Delts:under_hit"],
                  affected: {
                    muscle: "Side Delts",
                    slotIds: ["upper_a", "upper_b"],
                    laneIds: ["side_delt_isolation"],
                    weekNumbers: [1, 2, 3, 4],
                  },
                  ...
                  boundedDelta: {
                    ...
                    netWeeklySetDeltaStatus: "not_owner_specific",
                  },
                  slotOwnedContext: {
                    status: "blocked",
                    protectedStatus: "blocked",
                    candidateSlotOwners: ["upper_a", "upper_b"],
                    eligibleDonorCount: 1,
                    eligibleDonorMuscles: ["Glutes"],
                    donorSourceLogic: "eligible_donor_available",
                    blockingReasons: ["protected_status_blocked"],
                  },
                  downstreamProjection: {
                    slotAllocationStatus: "pass",
                    slotAllocationRowCount: 8,
                    setDistributionStatus: "pass",
                    setDistributionLaneCount: 8,
                  ...
                  materializationImpact: {
                    ...
                    slotSetDeltaBySlot: { upper_a: 2, upper_b: -1 },

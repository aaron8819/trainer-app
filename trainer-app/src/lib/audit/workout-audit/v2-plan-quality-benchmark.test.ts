      ...
      noRepairFixture({
        v2ConcentrationMaterializerProjection: {
          ...
          crossWeekReadiness: {
            ...
            noImpactWeekCount: 0,
            blockerCount: 2,
            nextSafeSlice: "design_slot_demand_redistribution_projection",
            gates: [
              {
              ...
              },
              {
                ...
                evidenceSource: "pure_v2_base_plan",
                evidence: ["one_step_lane_set_cap_has_no_donor_offset_model"],
                blockers: ["redistribution_donor_offset_not_projected"],
                requiredNextEvidence: ["slot_owned_donor_offset_projection"],
              },
              {

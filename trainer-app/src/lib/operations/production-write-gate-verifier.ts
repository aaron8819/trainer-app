...
export const APPLICATION_MUTATION_ROUTES = new Map<string, string>([
  ...
  ["plans/[id]/draft/route.ts#PATCH", "mesocycle_acceptance"],
  ["plans/[id]/regenerate/route.ts#POST", "mesocycle_acceptance"],
  ["plans/[id]/copy/route.ts#POST", "mesocycle_acceptance"],
  ...
  ["finishers/route.ts#POST", "application_configuration"],
  ["finishers/reorder/route.ts#POST", "application_configuration"],
  ["finishers/[id]/route.ts#PATCH", "application_configuration"],
  ["finishers/[id]/route.ts#DELETE", "application_configuration"],
  ["finishers/[id]/duplicate/route.ts#POST", "application_configuration"],
  ["finishers/[id]/archive/route.ts#POST", "application_configuration"],
  ["finishers/[id]/restore/route.ts#POST", "application_configuration"],

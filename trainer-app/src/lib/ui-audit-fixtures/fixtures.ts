...
function buildFixtureVolumeDisplay(input: {
  ...
  return {
    ...
    targetLabel: `Preferred target: ${formatFixtureSetCount(input.target)} weighted sets`,
    deltaLabel:
      delta === 0
        ? "on target"
  ...
  volumeThisWeek: [
    {
      ...
      statusDescription:
        "Productive floor reached; below preferred target (10 of 12 weighted sets).",
      badges: [{ status: "in_range", label: "Productive zone" }],
      opportunityScore: 72,
    ...
    },
    {
      ...
      statusDescription: "7 weighted sets; below the MEV floor. Preferred target: 10.",
    ...
    },
    {
      ...
      statusDescription: "Productive zone; preferred target reached (13 of 12 weighted sets).",
      badges: [{ status: "on_target", label: "Preferred target reached" }],
      opportunityScore: 34,
    ...
    },
    {
      ...
      statusLabel: "Below MEV",
      statusDescription: "5 weighted sets; below the MEV floor. Preferred target: 9.",
      badges: [{ status: "below_mev", label: "Below MEV" }],
      opportunityScore: 79,
      opportunityState: "high_opportunity",
    ...
    sessions: [
      {
        ...
        href: "/workout/ui-audit-workout-completed",
        workoutId: "ui-audit-workout-completed",
        sequenceIndex: 0,
      },
      {
        slotId: "pull-a",
        ...
        status: "next",
        statusLabel: "Next",
        href: "/log/ui-audit-workout-planned",
        workoutId: "ui-audit-workout-planned",
        sequenceIndex: 1,
      },
      {
...
const emptyHomeProgram = {
  ...
  gapFill: {
    ...
    targetMuscles: [],
    deficitSummary: [],
    detail: "No optional week completion action is available.",
    actionLabel: null,
    actionMethod: null,
    actionHref: null,
    canDismiss: false,
...
const activeProgram: ProgramPageData = {
  ...
  currentWeekPlan: {
    ...
    slots: [
      ...
      },
      {
        ...
        uiState: "projected",
        statusLabel: "Projected",
        statusDescription: "Session 4 is unresolved; its volume is projected as remaining work.",
        volumeBasis: "projected_remaining",
        linkedWorkoutId: null,
        linkedWorkoutStatus: null,
  ...
  closeout: {
    title: "Week 2 optional session",
    workoutId: "ui-audit-closeout",
    status: "PLANNED",
    statusLabel: "Planned",
    detail:
      "Optional manual session for Week 2. It counts toward that week's actual volume once performed, but it is not part of your current slot map.",
    ...
    rows: [
      {
        ...
        ...buildFixtureVolumeDisplay({ effectiveSets: 7, target: 10, mev: 8, mav: 14, mrv: 18 }),
        statusLabel: "Below MEV",
        statusDescription: "7 projected is still below the MEV floor after the planned week.",
        deltaLabel: "-3 sets",
        comparisonLabel: "7 projected vs 10 preferred target",
        badges: [],
      },
      {
        muscle: "Hamstrings",
        ...
        statusLabel: "Productive zone",
        statusDescription:
          "7.5 projected reaches the productive floor; below the 9 preferred target only. 5 completed so far.",
        deltaLabel: "-1.5 sets",
        comparisonLabel: "7.5 projected vs 9 preferred target",
        badges: [],
      },
      {
        muscle: "Chest",
        ...
        statusLabel: "Preferred target reached",
        statusDescription:
          "12 projected reaches the preferred target inside the productive zone; 8 completed so far.",
        deltaLabel: "on target",
        comparisonLabel: "12 projected vs 12 preferred target",
        badges: [],
      },
      {
        muscle: "Quads",
        ...
        statusLabel: "Preferred target reached",
        statusDescription:
          "14 projected reaches the preferred target inside the productive zone; 9 completed so far.",
        deltaLabel: "+2 sets",
        comparisonLabel: "14 projected vs 12 preferred target",
        badges: [],
      },
    ],
    defaultRows: [
...
const activeFixture: UiAuditFixture = {
  ...
  home: {
    ...
    decision: {
      ...
      activeWeekSessions: activeHomeProgram.activeWeekPlan.sessions,
    ...
    closeout: {
      ...
      statusLabel: "Planned",
      detail:
        "Optional manual session for Week 2. It can add actual volume to that week without becoming part of your current slot plan.",
      actionHref: "/log/ui-audit-closeout",
      actionLabel: "Open custom session",
      dismissActionHref: "/api/workouts/ui-audit-closeout/dismiss-closeout",
      dismissActionLabel: "Hide optional session",
...
const handoffFixture: UiAuditFixture = {
  ...
  home: {
    ...
    primaryAction: {
      ...
      href: "/mesocycles/ui-audit-meso-handoff/review",
    },
    decision: null,
    continuity: {
      summary: null,
